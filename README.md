...
- This project is called Bookstore. It is a web app built with React and Redux for users to browse for books and also add new books.
...
- **[Page-routing is implemented with react router 6]**
...
```sh
  git clone https://github.com/Otegaa/bookstore.git
  cd bookstore
```
...
Feel free to check the [issues page](https://github.com/Otegaa/bookstore/issues).
...
This project is [MIT](https://github.com/Otegaa/bookstore/blob/dev/LICENSE) licensed.
